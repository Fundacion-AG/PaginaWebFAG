	...
	<div class="evofp-table-row" style="display:table-row;width:<?php echo $column_percentage*$number_of_column; ?>%">
		<?php for($column=1; $column<=$number_of_column;$column++) { ?>
			<?php
					...
					echo '<div class="evofp-other-article" style="display:table-cell">';
...
echo '<div class="evofp-table-cell" style="display:table-cell;width:<?php echo $column_percentage; ?>%;word-wrap:break-word !important">';
