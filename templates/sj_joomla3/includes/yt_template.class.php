...
class YtTemplate {
	...
	function getCopyright(){
        ...
        -->
        <div class="footer1"> &copy; 2014 Fundaci&oacuten Amigos del Gesto.<a href="http://localhost:8080/FundacionAmigosdelGesto/index.php/noticias/10-fag/33-creditos"> Desarrollado por: UNEG/UCAB.</a> </div>
