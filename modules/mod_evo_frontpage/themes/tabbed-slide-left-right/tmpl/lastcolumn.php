...
<div class="evofrontpage-tabbed-slide-left-right" id="evofrontpage-<?php echo $evofpid; ?>">
...
<div style="display:table;table-layout:fixed;width:100%;padding:0 !important; margin:0 !important;" class="evofrontpageid">
	...
	<div class="anim-div" style="position:relative;">
		<?php for($row=1; $row<=$number_of_row;$row++){ ?>
			...
			<?php endif; ?>
				<div class="evofp-table-row" style="display:table-row;100%;">
					<?php for($column=1; $column<=$number_of_column;$column++) { ?>
					<div class="evofp-table-cell" style="display:table-cell;width:<?php echo $column_percentage_inner; ?>%;word-wrap:break-word !important">
...
<div class="evofp-below-row" ></div>
	...
	<?php if($show_others && $show_more_article){ ?>
	<div class="evofp-other-article" style="display:table-cell;width:<?php echo $column_percentage; ?>%;">
