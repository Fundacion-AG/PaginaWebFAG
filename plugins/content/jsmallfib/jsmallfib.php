...
//		error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
		...
		$this->filter_list_width 	= $this->params->def('filter_list_width', '220');
                ...
                $this->imgdirNavigation         = "plugins/content/jsmallfib/media/original/navigationIcons/";
                $this->imgdirExtensions         = "plugins/content/jsmallfib/media/original/extensionsIcons/";
                $this->icon_width = 18;
                $this->icon_padding = 5;
...
//		$document =& JFactory::getDocument();
		...
		$log_type = LOG_TYPE_TEXT;
                $logfile_prefix    = JPATH_ROOT.DS."logs".DS."jsmallfib_log_".md5($starting_dir);
                $logfile_extension = ".txt";
                $logfile_consolidation = LOG_FILE_MULTIPLE;
...
//			$split_upload_section = $this->params->def('split_upload_section', 0);
	...
	// ***********************************************************************************************************************
		...
		$username = JText::_('unregistered_visitor');
			...
			$log_file = $logfile_prefix."_uploads".$logfile_extension;
			...
			$log_file = $logfile_prefix."_removedfiles".$logfile_extension;
			...
			$log_file = $logfile_prefix."_restoredfiles".$logfile_extension;
			...
			$log_file = $logfile_prefix."_newfolders".$logfile_extension;
			...
			$log_file = $logfile_prefix."_newfoldernames".$logfile_extension;
			...
			$log_file = $logfile_prefix."_newfilenames".$logfile_extension;
			...
			$log_file = $logfile_prefix."_unzippedfiles".$logfile_extension;
